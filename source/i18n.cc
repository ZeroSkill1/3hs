	...
	[lang::dutch] =
		{
			...
			[str::ask_extra] = "Vraag naar extras",
			...
			[str::light_mode_desc] = "Zet lichte modus aan. Dit zal het uiterlijk van 3hs een lichtere tint geven",
			...
			[str::ask_extra_desc] = "Vraag om extras te installeren na de installatie van een spel",
